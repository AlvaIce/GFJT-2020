    ...
    public class MetaDataUserRaster:MetaData
    {
        ...
        public DateTime? productDate
        {
            ...
            get
            {
                try
                {
                    return DateTime.Parse(userRasterValues[4]);
                }
                catch (Exception)
                {
                    return null;
        ...
        public DateTime? sceneDate
        {
            ...
            get
            {
                try
                {
                    return DateTime.Parse(userRasterValues[8]);
                }
                catch (Exception)
                {
                    return null;
        ...
        public override void ImportData()
        {
            try
            {
                ...
                ID = isdbUtility.GetMaxID("ID", "isdb_userraster");
                QRST_CODE = tablecode.GetDataQRSTCode("isdb_userraster", ID);

                StringBuilder strSql = new StringBuilder();
                strSql.Append("insert into isdb_userraster(");
                strSql.Append("ID,DataType,proName,proEngName,proLevel,prodataName,productDate,dataName,satelliteId,sensorId,sceneDate,pixelSpacing,sceneCenterLat,sceneCenterLong,dataUpperLeftLat,dataUpperLeftLong,dataUpperRightLat,dataUpperRightLong,dataLowerLeftLat,dataLowerLeftLong,dataLowerRightLat,dataLowerRightLong,dataFormatDes,SceneRow,ScenePath,mapProjection,QRST_CODE)");
