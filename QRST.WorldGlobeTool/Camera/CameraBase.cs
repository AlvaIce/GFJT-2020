...
namespace QRST.WorldGlobeTool.Camera
{
    ...
    public class CameraBase
    {
        ...
        /// <summary>
        /// Projection matrix used in last render.
        /// 最近渲染使用的投影变换矩阵
        /// </summary>
        protected Matrix m_ProjectionMatrix;
        /// <summary>
        /// View matrix used in last render.
        /// 最近渲染使用的视角变换矩阵
        /// </summary>
        ...
        /// 数字缩放（键盘/鼠标滚轮方式）
        /// </summary>
        /// <param name="ticks">Positive value for zoom in, negative for zoom out.（正值放大，负值缩小）</param>
        public virtual void ZoomStepped(float ticks)
        {
            ...
            //TODO:20131230-ZYM:设置最小可见高度为100M
        ...
        /// 相机的放大或缩小（按距离方式）
        /// </summary>
        /// <param name="percent">Positive value = zoom in, negative=out（正值放大，负值缩小）</param>
        ...
        /// 获取应用程序以°为单位的可视域外边框
        /// </summary>
        /// <returns>An array of Angles in minx.miny,maxx, maxy order（按最小X，最小Y，最大X，最大Y顺序的角度数组）</returns>
