...
namespace QRST.WorldGlobeTool
{
    ...
    public class WorldSettings
    {
        ...
        /// 获取或设置三维球体的数据目录
        /// </summary>
        [Browsable(true), Category("路径设置")]
        [Description("三维球体基础数据存放目录。")]
        ...
        /// </summary>
        [Browsable(true), Category("路径设置")]
        [Description("三维球体缓存数据存放目录。")]
        public string CacheDirectory
        {
            get { return m_CacheDirectory; }
            set { m_CacheDirectory = value; }
        }
        ...
        {
            get { return WebDownload.Log404Errors; }
            set { WebDownload.Log404Errors = value; }
        }
        ...
        /// 默认字体大小
        /// </summary>
        internal float defaultFontSize = 19.0f;
        ...
        /// </summary>
        internal bool ShowToolbar = false;
        ...
        /// Toc窗体中显示Layer的字体的大小
        /// </summary>
        internal float layerManagerFontSize = 20;
        ...
        /// 图层管理菜单的宽度
        /// </summary>
        internal int layerManagerWidth = 160;

        /// <summary>
        /// TocBar的背景色
        /// </summary>
        internal int menuBackColor = Color.FromArgb(100, 40, 40, 40).ToArgb();
        /// <summary>
        /// Tocbar的边框
        /// </summary>
        ...
        /// 工具条中字体的名称
        /// </summary>
        internal string m_ToolbarFontName = "Tahoma";
        ...
        {
            get { return m_ToolbarFontName; }
            set { m_ToolbarFontName = value; }
        }

        /// <summary>
        /// 工具条中字体大小
        /// </summary>
        internal float toolbarFontSize = 16;
        ...
        {
            get { return showCopyright; }
            set { showCopyright = value; }
        }
        ...
        public Object CurrentWwTool
        {
            ...
            set
            {
                if (value == null)
                {
                    QRSTWorldGlobeControl.m_IsMouseToolUsing = false;
                }
                else
                {
                    QRSTWorldGlobeControl.m_IsMouseToolUsing = true;
                }
        ...
        /// </summary>
        [XmlIgnore]
        [Browsable(true), Category("测量工具")]
        [Editor(typeof(ColorEditor), typeof(UITypeEditor))]
        [Description("距离测量线条的线条颜色。")]
        ...
        internal bool m_ShowCompass = false;
        internal bool m_ShowLevelBar = false;
        ...
        {
            get { return m_ShowCompass; }
            set { m_ShowCompass = value; }
        }
        ...
        /// </summary>
        [Browsable(true), Category("UI")]
        [Description("Show LevelBar Indicator.")]
        public bool ShowLevelBar
        {
            get { return m_ShowLevelBar; }
            set { m_ShowLevelBar = value; }
        }
