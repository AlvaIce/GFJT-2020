...
namespace QRST.WorldGlobeTool.Renderable
{
    ...
    /// 使用这个类来将一个单影像映射到球体上的指定高度，原始影像必须是方格地图投影
    /// </summary>
    public class ImageLayer : RenderableObject
    {
        ...
        public override Extension Extension
        {
            get
            {
                return new Extension(maxLat, minLat, minLon, maxLon);
            }
        }
        /// <summary>
        /// 图层半径
        ...
        public double UpLon=0;
        public double UpLat = 0;
        public double DownLon = 0;
        public double DownLat = 0;
        public double LeftLon = 0;
        public double LeftLat = 0;
        public double RightLon = 0;
        public double RightLat = 0;

        public bool UsingUDLRDrawing = false;
        ...
        /// 
        /// </summary>
        protected ColorbarLegend legendControl;
        /// <summary>
        /// 透明色。
        /// </summary>
        ...
        public override void Render(DrawArgs drawArgs)
        {
            ...
            try
            {
                ...
                if (!RenderGrayscale || (device.DeviceCaps.PixelShaderVersion.Major < 1))
                {
                    ...
                    //                drawArgs.device.DrawIndexedUserPrimitives(PrimitiveType.LineStrip, 0,
                    //vertices.Length, indices.Length, indices, true, vertices);
        ...
        public void UpdateTexture(string fileName)
        {
            try
            {
                if (this.device != null)
                {
                    ...
                    Texture newTexture = ImageHelper.LoadTexture(fileName, TransparentColor);
        ...
        public void UpdateTexture(Stream textureStream, int transparentColor)
        {
            try
            {
                if (this.device != null)
                {
                    ...
                    Texture newTexture = ImageHelper.LoadTexture(textureStream, transparentColor);
                    this.texture = newTexture;
        ...
        public override void BuildContextMenu(System.Windows.Forms.ContextMenu menu)
        {
            ...
            System.Windows.Forms.MenuItem mi = new System.Windows.Forms.MenuItem("显示图例",
