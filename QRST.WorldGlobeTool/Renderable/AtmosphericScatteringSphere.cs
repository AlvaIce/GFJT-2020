...
namespace QRST.WorldGlobeTool.Renderable
{
    ...
    public class AtmosphericScatteringSphere
    {
        ...
        void device_DeviceReset(object sender, EventArgs e)
        {
            ...
            Stream skyFromSpaceStream = assembly.GetManifestResourceStream("QRST.WorldGlobeTool.Shaders.SkyFromSpace.fx");
            ...
            Stream skyFromAtmosphereStream = assembly.GetManifestResourceStream("QRST.WorldGlobeTool.Shaders.SkyFromAtmosphere.fx");
