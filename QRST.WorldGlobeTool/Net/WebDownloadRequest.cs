...
namespace QRST.WorldGlobeTool.Net
{
    ...
    public class WebDownloadRequest : DownloadRequest
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref= "T:Qrst.Net.WebDownloadRequest"/> class.
        /// </summary>
        /// <param name="owner">The object owning this request.</param>
        public WebDownloadRequest(object owner)
            : base(owner)
        {
        ...
        public WebDownloadRequest(object owner, string url)
            : base(owner)
        {
