...
namespace QRST_DI_MS_Component_DataImportorUI.Vector
{
    public partial class ctrlVectorDataImport : UserControl
    {
        ...
        IDbBaseUtilities bsdbUtil = null;
        ...
        public void Create(IDbBaseUtilities bsdb, userInfo currentUser)
        {
            bsdbUtil = bsdb;
        ...
        {
            importData.VectorImportCtrl = this;
        ...
        {
            importData.UsingVirtualDir = ctrlVirtualDirSetting1.UsingVirtualDir;
