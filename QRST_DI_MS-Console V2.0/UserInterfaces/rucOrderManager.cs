...
namespace QRST_DI_MS_Desktop.UserInterfaces
{
    class rucOrderManager : RibbonPageBaseUC
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.btnCreateOrder.LargeGlyph = global::QRST_DI_MS_Desktop.Properties.Resources.创建新订单1;
            ...
            this.barButtonItem1.LargeGlyph = global::QRST_DI_MS_Desktop.Properties.Resources.订单等待;
            ...
            this.barProcessingLst.LargeGlyph = global::QRST_DI_MS_Desktop.Properties.Resources.正在执行;
            ...
            this.barButtonItemSuspend.LargeGlyph = global::QRST_DI_MS_Desktop.Properties.Resources.挂起订单;
            ...
            this.barButtonItemSearch.LargeGlyph = global::QRST_DI_MS_Desktop.Properties.Resources.查看详细结果版面;
        ...
        private void OrderDefined(object sender, FrmAddTask.MessageEventArgs me)
        {
        ...
        string ConstructQueryCondition()
        {
            ...
            if (barEditItemStartTime.EditValue != null && barEditItemStartTime.EditValue.ToString() != "")
            {
                ...
                sb.AppendFormat(" 提交时间 >= '{0}' and", startTime);
            }
            if (barEditItemEndTime.EditValue != null && barEditItemEndTime.EditValue.ToString() != "")
            {
                ...
                sb.AppendFormat(" 提交时间 <= '{0}' and", endTime);
            }
