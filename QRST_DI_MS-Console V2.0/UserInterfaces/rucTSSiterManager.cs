...
{
    public class rucTSSiterManager : RibbonPageBaseUC
    {
        ...
        private void InitializeComponent()
        {
            ...
            // barButtonItem1
            // 
            this.barButtonItem1.Caption = "站点列表";
            this.barButtonItem1.Id = 1;
            this.barButtonItem1.LargeGlyph = global::QRST_DI_MS_Desktop.Properties.Resources.服务器阵列;
            ...
            this.repositoryItemCheckCPU.CheckStateChanged += new System.EventHandler(this.repositoryItemCheckCPU_CheckStateChanged);
            // 
            // barEditIteMEM
            // 
            ...
            this.barButtonItem5.LargeGlyph = global::QRST_DI_MS_Desktop.Properties.Resources.站点添加;
            ...
            this.barButtonItem6.LargeGlyph = global::QRST_DI_MS_Desktop.Properties.Resources.站点更新;
            ...
            this.barButtonItem7.LargeGlyph = global::QRST_DI_MS_Desktop.Properties.Resources.站点删除;
            ...
            // barButtonItem8
            // 
            this.barButtonItem8.Caption = "节点监控信息";
            this.barButtonItem8.Id = 9;
            this.barButtonItem8.LargeGlyph = global::QRST_DI_MS_Desktop.Properties.Resources.站点信息1;
        ...
        //    InitializeComponent();
        //}
               public rucTSSiterManager(object objMUC)
            : base(objMUC)
        {
            InitializeComponent();
        }
       ...
       /// <param name="e"></param>
               private void repositoryItemCheckCPU_CheckStateChanged(object sender, EventArgs e)
               {
              //     bool checkState = 
                   ((mucTSSiterManager)ObjMainUC).HideSeries("SeriesCPURate", (bool)((CheckEdit)sender).EditValue);
               }
      /// <summary>
      /// 内存使用
      /// </summary>
      ...
      /// <param name="e"></param>
               ...
               {
                   ((mucTSSiterManager)ObjMainUC).HideSeries("SeriesMemRate", (bool)((CheckEdit)sender).EditValue);
               }
       /// <summary>
       /// 未用磁盘
       /// </summary>
       ...
       /// <param name="e"></param>
               ...
               {
                   ((mucTSSiterManager)ObjMainUC).HideSeries("SeriesUnusedMemory", (bool)((CheckEdit)sender).EditValue);
               }
       /// <summary>
       /// 已用磁盘
       /// </summary>
       ...
       /// <param name="e"></param>
               ...
               {
                   ((mucTSSiterManager)ObjMainUC).HideSeries("SeriesUsedMemory", (bool)((CheckEdit)sender).EditValue);
               }
       ...
       /// <param name="e"></param>
               ...
               {
                   ((mucTSSiterManager)ObjMainUC).OpenTabPage(0);
               }
               ...
               private void repositoryItemComboBox1_EditValueChanged(object sender, EventArgs e)
               {
                   try
                   {
                       ...
                       ((mucTSSiterManager)ObjMainUC).SetTimeSpan(interval * 1000);
                   }
                   catch (Exception)
                   {
               ...
               {
                   ((mucTSSiterManager)ObjMainUC).OpenTabPage(1);
               }
