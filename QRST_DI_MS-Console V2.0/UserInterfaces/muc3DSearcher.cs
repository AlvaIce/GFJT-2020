...
namespace QRST_DI_MS_Desktop.UserInterfaces
{
    public partial class muc3DSearcher : UserControl
    {
        ...
        private void EarthLoad()
        {
            ...
            this.qrstAxGlobeControl1.QrstGlobe.ShowLayerManager = false;
            this.qrstAxGlobeControl1.QrstGlobe.AddChinaShapeLayerSet();
            ...
            //        25, 25, Path.Combine(this.qrstAxGlobeControl1.DataDirectory, @"Icons\placemark_circle.png"), 5000000, 0, Color.White, Color.Black);
