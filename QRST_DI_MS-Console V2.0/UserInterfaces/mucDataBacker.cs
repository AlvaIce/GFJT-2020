...
namespace QRST_DI_MS_Desktop.UserInterfaces
{
    public partial class mucDataBacker : UserControl
    {
        ...
        public static List<string> GetAllTablesName(string sql)
        {
            ...
            tablename = dbOperating.GetSubDbUtilities(EnumDBType.MIDB).myExcuteReader(sql);
            return tablename;
        }
        public static List<string> GetAllViewName(string sql2)
        {
            List<string> viewname;
            viewname = dbOperating.GetSubDbUtilities(EnumDBType.MIDB).myExcuteReader(sql2);
            return viewname;
        }
        ...
        public static string GetAutoBackupAddress()
        {
            ...
            string AutoAddress = dbOperating.GetSubDbUtilities(EnumDBType.MIDB).myExcuteScalar(AutoSql);
            return AutoAddress;
        }
        ...
        public static string GetAutoBackupSpan()
        {
            ...
            string AutoSpan = dbOperating.GetSubDbUtilities(EnumDBType.MIDB).myExcuteScalar(AutoSpanSql);
            return AutoSpan;
        }
        ...
        public static string GetLastBackupTime()
        {
            ...
            string AutoLastBackupTime = dbOperating.GetSubDbUtilities(EnumDBType.MIDB).myExcuteScalar(AutoLastTimeSql);
        ...
        public void getautoBackupTables()
        {
            ...
            autoBackupTables = dbOperating.GetSubDbUtilities(EnumDBType.MIDB).myExcuteScalar(sql);
        ...
        public static void ChangeAutoBackupSpan(int span)
        {
            ...
            dbOperating.GetSubDbUtilities(EnumDBType.MIDB).ExecuteSql(ChangeBackupSpanSql);
        }
        ...
        public static void ChangeAutoBackupAddress(string address)
        {
            ...
            dbOperating.GetSubDbUtilities(EnumDBType.MIDB).ExecuteSql(ChangeBacukpAddressSql);
        }
        ...
        public static void ChangeAutoBackupTables(string tables)
        {
            ...
            dbOperating.GetSubDbUtilities(EnumDBType.MIDB).ExecuteSql(ChangeBackupTableSql);
        }
        ...
        public void backuptranslog()
        {
            try
            {
                ...
                dst = dbOperating.GetSubDbUtilities(EnumDBType.MIDB).GetDataSet(selectbackuptranslog);
                dst.Tables.Add(dt);
