...
{ 
    ...
    {    
         public static frm_MSConsole2 MainForm { get; set; }
         public static rucDataImport RucDataImport { get; set; }
         ...
         public static SiteDb INDB
         {
             get { return GetsubDbByEngName("INDB"); }
         }
         ...
         public static VirtualDirUC _VirtualDirUC { get; set; }
    }
}
