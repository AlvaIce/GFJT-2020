...
{
    public partial class frm_MSConsole : DevExpress.XtraEditors.XtraForm
    {
        public MSUserInterface newMSUI;
        public frm_MSConsole()
        {
            //注册使用非默认皮肤包
            BonusSkins.Register();
        ...
        private void InitializeMSUserInterfase()
        {
            ...
            DataTable subDbArr = baseUtilities.GetDataSet("select * from subdbinfo ").Tables[0];
