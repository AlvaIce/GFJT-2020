...
namespace QRST_DI_TS_Process.Service
{
    ...
    public class ping
    {
        ...
        public int PingHostInt(string host)
        {
            ...
            if (Index == -1)
            {
                return -2;      //-2= "Error Creating Packet";
            }
            ...
            if (Index == -1)
            {
                return -3;      //-3= "Error Creating Packet";
            ...
            {
                return -3;      //-3= "Socket Error: cannot send Packet";
            }
            ...
            while (!recd)
            {
                ...
                {
                    dwStop = Environment.TickCount - dwStart + 1; // stop timing
                    return dwStop;
        ...
        public string PingHostStr(string host)
        {
            // 声明 IPHostEntry
            IPHostEntry serverHE, fromHE;
            int nBytes = 0;
