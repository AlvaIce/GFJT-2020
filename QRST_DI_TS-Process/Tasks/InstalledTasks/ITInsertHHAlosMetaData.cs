...
{
    public class ITInsertHHAlosMetaData : TaskClass
    {
        /// <summary>
        /// 任务名,定义唯一标识，不可动态修改
        /// </summary>
        ...
        {
            get { return "ITInsertHHAlosMetaData"; }
            set { }
        }
        ...
        public override void Process()
        {
            ...
            try
            {
                ...
                mdDBImporter.ImportData(EnumMetadataTypes.HHALOS, metRaster, excelFilePath, TServerSiteManager.ConvertTSSiteIP2TSSiteCode(this.ParentOrder.TSSiteIP), out insertSql);
            }
            catch (System.Exception ex)
            {
                this.ParentOrder.Logs.Add(string.Format("海河流域ALOS数据元数据插入异常{0}", ex.Message));
            }
