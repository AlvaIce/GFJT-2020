...
namespace Qrst.DrawUtils
{
    //public class DrawPointLayer : DrawBaseLayer
    //{
    //    protected float lineWidth = 1.0f;
    //    protected double MinAltitude = 0;
    //    protected double MaxAltitude = 5700000;

    //       public DrawPointLayer(string pName, Color pColor, World pWorld, DrawArgs drawArgs)
    //        : base(pName, pColor, pWorld, drawArgs) 
    //    {
    //    }

    //       public DrawPointLayer(string pName, Color pColor, DrawBaseTool drawTool, DrawArgs drawArgs)
