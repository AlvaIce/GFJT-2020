...
namespace Qrst.Camera
{
    ...
    public class WorldCamera : CameraBase
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref= "T:Qrst.Camera.WorldCamera"/> class.
        /// </summary>
    ...
    public class MomentumCamera : WorldCamera
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref= "T:Qrst.Camera.MomentumCamera"/> class.
        /// </summary>
        /// <param name="targetPosition"></param>
        /// <param name="radius"></param>
        public MomentumCamera(Vector3 targetPosition, double radius)
            : base(targetPosition, radius)
        {
            this._targetOrientation = m_Orientation;
            this._targetDistance = this._distance;
