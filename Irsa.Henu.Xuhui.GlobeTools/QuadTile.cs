...
namespace Qrst.Renderable
{
	public class QuadTile : IDisposable
	{
		...
		/// <summary>
		/// 初始化一个新的切片（Tile） <see cref= "T:Qrst.Renderable.QuadTile"/> class.
		/// </summary>
	...
	&& DrawArgs.Camera.ViewFrustum.Intersects(BoundingBox)
        ...
        void device_DeviceReset(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                Stream stream = assembly.GetManifestResourceStream("Qrst.Shaders.grayscale.fx");
