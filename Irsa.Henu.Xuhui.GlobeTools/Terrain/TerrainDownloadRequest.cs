...
namespace Qrst.Terrain
{
    ...
    public class TerrainDownloadRequest : GeoSpatialDownloadRequest
    {
        ...
        protected void ProcessFile()
        {
            ...
            else if (download.ContentType == "application/zip; charset=utf-8")
            {
                if (File.Exists(SaveFilePath))
                    File.Delete(SaveFilePath);
...
namespace Qrst.Net
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref= "T:Qrst.Net.GeoSpatialDownloadRequest"/> class.
        /// </summary>
        /// <param name="owner"></param>
        /// <param name="uri"></param>
        protected GeoSpatialDownloadRequest(object owner, string uri)
            : base(owner, uri)
        {
        ...
        /// </summary>
        /// <param name="owner"></param>
        protected GeoSpatialDownloadRequest(object owner)
            : this(owner, null)
        {
        }
