...
namespace QRST_DI_MS_Console.UserInterfaces
{
    public partial class rucSpectrumSearch : RibbonPageBaseUC
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.barButtonItem_search.LargeGlyph = global::QRST_DI_MS_Console.Properties.Resources.三维可视化检索;
            ...
            try
            {
                switch (this.barEditItem_feature.EditValue.ToString())
                {
                    ...
                    case "土壤":
                        ...
                        classify = JSON.JSON.parse<GetClassify>(soilclient.getTypes());
                        classifyfgw = classify.types;
                        strFields = new string[classifyfgw.Length];
                        for (int i = 0; i < classifyfgw.Length; i++)
                        {
                    ...
                    case "岩矿":
                        ...
                        classify = JSON.JSON.parse<GetClassify>(rockclient.getSSLB());
                        classifyfgw = classify.types;
                        strFields = new string[classifyfgw.Length];
                        for (int i = 0; i < classifyfgw.Length; i++)
                        {
                        ...
                        classify = JSON.JSON.parse<GetClassify>(rockclient.getSubTypes());
                        classifyfgw = classify.types;
                        strFields = new string[classifyfgw.Length];
                        for (int i = 0; i < classifyfgw.Length; i++)
                        {
                        ...
                        classify = JSON.JSON.parse<GetClassify>(rockclient.getTypes());
                        classifyfgw = classify.types;
                        strFields = new string[classifyfgw.Length];
                        for (int i = 0; i < classifyfgw.Length; i++)
                        {
