...
{
    [Serializable]
    public class NormalFileQueryPara : QueryPara
    {
        ...
        public override ComplexCondition GetSpecificCondition(IGetQuerySchema querySchema)
        {
            ...
            string timeField = mapping.GetValue("NORMALFILE.TIME");
            ...
            string[] keywordsField = mapping.GetValue("NORMALFILE.GLOBALKEYWORDS").Split(":".ToCharArray());
