...
public partial class GetTileTinyView : System.Web.UI.Page
{

    private DirectlyAddressing _tileDA=null;
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (tilename != null)
        {
            ...
            try
            {
                ...
                byte[] imgdata = _optTSite.TCPService.GetTileTinyView(tilename);
