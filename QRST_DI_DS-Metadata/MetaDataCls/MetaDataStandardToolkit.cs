...
{
    public class MetaDataStandardToolkit:MetaData
    {
        ...
        public MetaDataStandardToolkit()
        {
        ...
        public override void ImportData(IDbBaseUtilities sqlBase)
        {
            try
            {
                ...
                Constant.IdbOperating.LockTable("madb_toolkit",EnumDBType.MIDB);
                tablecode_Dal tablecode = new tablecode_Dal(sqlBase);
                ID = sqlBase.GetMaxID("ID", "madb_toolkit");
                QRST_CODE = tablecode.GetDataQRSTCode("madb_toolkit", ID);
                StringBuilder strSql = new StringBuilder();
                strSql.Append("insert into madb_toolkit(");
                ...
                Constant.IdbOperating.UnlockTable("madb_toolkit",EnumDBType.MIDB);
